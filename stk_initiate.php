...
$config = array(
    ...
    "key"              => "wEk5dP9LsCv3OJX6YhY0Ia6CsDdJSROW", //Enter your consumer key here
    "secret"           => "aJk6nIJSWrlizLXD", //Enter your consumer secret here
    "username"         => "apitest",
    "TransactionType"  => "CustomerPayBillOnline",
    "passkey"          => "bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919, //Enter your passkey here
    "CallBackURL"      => 'http:\\localhost\Daraja\callback.php', //When using localhost, Use Ngrok to forward the response to your Localhost
    "AccountReference" => "Einstein",
